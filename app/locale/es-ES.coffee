...
#    play_campaign_version: "Play Campaign Version" # Shows up under big play button if you only play /courses
  ...
  new_home:
    ...
    classroom_edition: "Edición del Aula:"
    ...
    classroom_in_a_box: "Un aula en miniatura para aprender informática."
    codecombat_is: "CodeCombat es una plataforma <strong>para estudiantes</strong> que quieren aprender informática mientras juegan."
    our_courses: "Nuestros cursos han sido específicamente probados para <strong>destacar en el aula</strong>, incluso para profesores sin experiencia preiva en programación."
    top_screenshots_hint: "Los estudiantes programan y ven los cambios actualizados en tiempo real."
    designed_with: "Diseñado con los profesores en mente."
    real_code: "El programa escrito es real"
    from_the_first_level: "desde el primer nivel."
    getting_students: "Acercar a los estudiantes a programar lo más pronto posible es fundamental para aprender a programar con buena sintaxis y buena estructura."
    educator_resources: "Recursos para el educador"
    course_guides: "y guías del curso."
    teaching_computer_science: "Enseñar informática no requiere una titulación cara, porque proveemos herramientas para ayudar a los educadores con cualquier tipo de formación."
    accessible_to: "Accesible para"
    everyone: "todos"
    democratizing: "Democratizar el proceso de aprender a programar es la base de nuestra filosofía. Todo el mundo debería tener la posibilidad de aprender a programar."
    forgot_learning: "Creo que han olvidado que, en realidad, están aprendiendo algo."
    wanted_to_do: " Programar es algo que siempre había querido hacer, pero nunca pensé que podría aprenderlo en la escuela."
    why_games: "¿Por qué es tan importante aprender por medio de juegos?
    games_reward: "Los juegos recompensan el esfuerzo productivo.
    encourage: "El juego es un medio que promueve la interacción, el descubrimiento y el método de prueba y error. Un buen juego desafía al jugador a dominar habilidades con el tiempo, que es el mismo proceso crítico por que el que pasan los estudiantes en el proceso de aprendizaje."
    excel: "Los juegos sobresalen por recompensar"
    struggle: "el esfuerzo productivo"
    kind_of_struggle: "el tipo de esfuerzo que funciona al estudiar es el que es atractivo y"
    motivating: "motivador"
    not_tedious: "not aburrido."
    gaming_is_good: "Estudios sugieren que jugar es bueno para el cerebro de los niños. (¡Es verdad!)"
    game_based: "Cuando los sistemas de aprendizaje basados en el juego se"
    compared: "comparan"
    conventional: "con métodos de aprendizaje convencional, la diferencia es clara: los juegos son mejores para ayudar a los estudiantes a retener conocimiento, a concentrarse"
    perform_at_higher_level: "alcanzar un mayor nivel de progreso"
    feedback: "Los juegos también permiten una realimentación en tiempo real que permite a los estudiantes a ajustar su estrategia de resolución y entender conceptos de forma más práctica, en vez de limitarse a las respuestas "correcto" o "incorrecto"."
